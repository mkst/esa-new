...
#if 0
// need to match rest of the file
void func_8009D970(void) {
    ...
    if (((D_800E5274->unk386 - 3) < 2U) && ((func_8001CEB4() & 0xFF) == 0x9C)) {
        play_sound_effect_at_location(0x63, D_800E527C->xPos, D_800E527C->zPos);
    }
    if ((D_800E529C->unk90 == 0x13) && (((D_800E5274->unk340 == NULL)) || (D_800E5274->unk340->unk274 != 0))) {
        play_sound_effect_at_location(0x63, D_800E527C->xPos, D_800E527C->zPos);
        D_800E5274->unk340 = NULL;
        D_800E5274->yPos += D_800E5274->unk328;
    ...
    func_8006BC30(D_800E5274->xPos, D_800E5274->zPos, D_800E5274->yPos + (D_800E529C->unkAE >> 1), D_800E5274->unk322, 0, 0x12, 0x12, 0x9B, 0, 0, 0, 0, D_800E525C);
...
#else
INCLUDE_ASM("asm/esa/nonmatchings/vulture", func_8009D970);
#endif

// sssv:func_8036D30C_77E9BC
INCLUDE_ASM("asm/esa/nonmatchings/vulture", func_8009DD48);

// sssv:func_8036D5CC_77EC7C
